...
function DevBot(msg) 
local hash = database:sismember(bot_id.."Hydra:Sudo:User", msg.sender_user_id_) 
if hash or DevHydra(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevHydra(msg) or DevBot(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."Hydra:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevHydra(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."Hydra:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevHydra(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."Hydra:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or DevHydra(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."Hydra:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or DevHydra(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./Hydra');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/Hydra.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
if DevHydraa(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."Hydra:Sudo:User", user_id) then
...
var = database:get(bot_id.."Hydra:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."Hydra:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."Hydra:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."Hydra:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."Hydra:GBan:User",User_id) then
Var = true
else
Var = false
end
...
database:sadd(bot_id..'Hydra:Chek:Groups',idg) 
database:set(bot_id.."Hydra:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Hydra:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."Hydra:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."Hydra:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."Hydra:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."Hydra:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."Hydra:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
pre_msg = plugin.Hydra(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function Hydra_Started_Bot(msg,data) -- بداية العمل
if msg then
...
database:incr(bot_id..'Hydra:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'Hydra:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
...
database:set(bot_id..'Hydra:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'Hydra:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'Hydra:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'Hydra:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
local type = database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."Hydra:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Hydra:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."Hydra:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."Hydra:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."Hydra:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydrae:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."Hydra:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."Hydra:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Hydra:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Hydra:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."Hydra:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."Hydra:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Hydra:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."Hydra:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."Hydra:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."Hydra:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."Hydra:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Hydra:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."Hydra:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."Hydra:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."Hydra:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."Hydra:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."Hydra:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."Hydra:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."Hydra:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."Hydra:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Hydra:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء وضع الوصف") 
database:del(bot_id.."Hydra:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Hydra:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Hydra:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء حفظ الترحيب") 
database:del(bot_id.."Hydra:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Hydra:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."Hydra:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"📮┇تم حفظ ترحيب المجموعه")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Hydra:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"📥┇تم الغاء حفظ الرابط")       
database:del(bot_id.."Hydra:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."Hydra:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."Hydra:Hydra:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه للخاص") 
database:del(bot_id.."Hydra:Hydra:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'Hydra:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."Hydra:Hydra:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."Hydra:Hydra:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."Hydra:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."Hydra:Hydra:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇تم الغاء الاذاعه") 
database:del(bot_id.."Hydra:Hydra:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."Hydra:UsersBot")   
...
if database:get(bot_id.."Hydra:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_, msg.id_,"📫┇ تم الغاء حفظ اسم البوت") 
database:del(bot_id.."Hydra:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."Hydra:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."Hydra:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "📥┇ تم حفظ اسم البوت")  
return false
end 
if text and database:get(bot_id.."Hydra:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."Hydra:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰┇ارسل الامر الجديد")  
database:del(bot_id.."Hydra:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."Hydra:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."Hydra:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."Hydra:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."Hydra:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."Hydra:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"🔰┇تم حفظ الامر")  
database:del(bot_id.."Hydra:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."Hydra:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."Hydra:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Hydra:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Hydra:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."Hydra:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."Hydra:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."Hydra:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."Hydra:Lock:pin",msg.chat_id_) 
...
database:set(bot_id.."Hydra:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."Hydra:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'Hydra:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."Hydra:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."Hydra:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."Hydra:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."Hydra:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."Hydra:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."Hydra:lockpin"..msg.chat_id_)  
database:srem(bot_id.."Hydra:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."Hydra:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."Hydra:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'Hydra:'..lock..msg.chat_id_)    
end
...
local list = database:smembers(bot_id.."Hydra:Sudo:User")
t = "\n⛔┇قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Hydra:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Hydra:Constructor"..msg.chat_id_)
t = "\n⛔┇قائمة المنشئين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Hydra:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Hydra:Manager"..msg.chat_id_)
t = "\n⛔┇قائمة المدراء \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Hydra:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Hydra:Mod:User"..msg.chat_id_)
t = "\n⛔┇قائمة الادمنيه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Hydra:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Hydra:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Hydra:Muted:User"..msg.chat_id_)
t = "\n⛔┇قائمة المكتومين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Hydra:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Hydra:Ban:User"..msg.chat_id_)
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevHydra(msg) then
...
database:sadd(bot_id.."Hydra:GBan:User", result.sender_user_id_)
...
database:sadd(bot_id.."Hydra:GBan:User", result.id_)
...
database:sadd(bot_id.."Hydra:GBan:User", userid)
...
if text and text:match("^الغاء العام @(.*)$") and DevHydra(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_Tshake(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","💢┇تم الغاء حظره عام من المجموعات")  
database:srem(bot_id.."Hydra:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"💢┇لا يوجد حساب بهاذا المعرف")
end
end
...
database:srem(bot_id.."Hydra:GBan:User", userid)
Reply_Status(msg,userid,"reply","💢┇تم الغاء حظره عام من المجموعات")  
return false
end

if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevHydra(msg) then
function Function_Tshake(extra, result, success)
database:sadd(bot_id.."Hydra:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
if text and text:match("^اضف مطور @(.*)$") and DevHydrae(msg) then
...
database:sadd(bot_id.."Hydra:Sudo:User", result.id_)
...
if text and text:match("^اضف مطور (%d+)$") and DevHydra(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."Hydra:Sudo:User", userid)
Reply_Status(msg,userid,"reply","💢┇تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevHydra(msg) then
function Function_Tshake(extra, result, success)
database:srem(bot_id.."Hydra:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false 
end
if text and text:match("^حذف مطور @(.*)$") and DevHydra(msg) then
local username = text:match("^حذف مطور @(.*)$")
function Function_Tshake(extra, result, success)
if result.id_ then
database:srem(bot_id.."Hydra:Sudo:User", result.id_)
...
if text and text:match("^حذف مطور (%d+)$") and DevHydra(msg) then
local userid = text:match("^حذف مطور (%d+)$")
database:srem(bot_id.."Hydra:Sudo:User", userid)
...
function Hydra(extra, result, success)
database:sadd(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_HyDrA(extra, result, success)
database:srem(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_Hydra(extra, result, success)
if result.id_ then
database:srem(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_Tshake(extra, result, success)
database:sadd(bot_id.."Hydra:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Hydra:Constructor"..msg.chat_id_, userid)
...
function Function_Hydra(extra, result, success)
database:srem(bot_id.."Hydra:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
end
...
database:srem(bot_id.."Hydra:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","💢┇تم تنزيله من المنشئين")  
end
...
function Function_Tshake(extra, result, success)
database:sadd(bot_id.."Hydra:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Hydra:Manager"..msg.chat_id_, userid)
...
function Function_Hydra(extra, result, success)
if result.id_ then
database:srem(bot_id.."Hydra:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Hydra:Manager"..msg.chat_id_, userid)
...
function Function_Tshake(extra, result, success)
database:sadd(bot_id.."Hydra:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Hydra:Mod:User"..msg.chat_id_, userid)
...
function Function_Tshake(extra, result, success)
if result.id_ then
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_, userid)
...
function Function_Hydra(extra, result, success)
database:sadd(bot_id.."Hydra:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Hydra:Special:User"..msg.chat_id_, userid)
...
function Function_Tshake(extra, result, success)
if result.id_ then
database:srem(bot_id.."Hydra:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Hydra:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."Hydra:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local Hydrart = database:get(bot_id.."Hydra:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if Tshakert == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."Hydra:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Hydra:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif Hydrart == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."Hydra:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Hydra:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif Hydraert == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬┇تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."Hydra:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Hydra:Manager"..msg.chat_id_,result.sender_user_id_)  
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local Tshakert = database:get(bot_id.."Hydra:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if Tshakert == "مميز" and Addictive(msg) then
...
if database:sismember(bot_id.."Hydra:Coomds"..msg.chat_id_,text1[2]) then
...
function py_username(extra, result, success)   
if result.id_ then
local Hydrart = database:get(bot_id.."Hydra:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if Tshakert == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n🔰┇تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."Hydra:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."Hydra:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif Hydrart == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤┇العضو » ["..result.title_.."](t.me/"..(text1[3] or "BOBBW")..")".."\n🔰┇تم تنريله من "..text1[2].." هنا")   
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."Hydra:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."Hydra:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Hydra:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Hydra:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."Hydra:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."Hydra:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Hydra:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Hydra:Muted:User"..msg.chat_id_, userid)
...
function Function_Hydra(extra, result, success)
database:srem(bot_id.."Hydra:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tshake(extra, result, success)
if result.id_ then
database:srem(bot_id.."Hydra:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Hydra:Muted:User"..msg.chat_id_, userid)
...
database:set(bot_id.."Hydra:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."Hydra:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"💢┇انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"📫┇ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
...
database:hset(bot_id.."Hydra:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."Hydra:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
send(msg.chat_id_, msg.id_,"📮┇تم وضع زمن التكرار ("..Num..")") 
end
if text == "ضع رابط" or text == "وضع رابط" then
if msg.reply_to_message_id_ == 0  and Addictive(msg) then  
send(msg.chat_id_,msg.id_,"📥┇ارسل رابط المجموعه او رابط قناة المجموعه")
database:setex(bot_id.."Hydra:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "تفعيل جلب الرابط" or text == 'تفعيل الرابط' then
if Addictive(msg) then  
database:set(bot_id.."Hydra:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."Hydra:Link_Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"☑┇تم تعطيل جلب رابط المجموعه") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."Hydra:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"☑┇جلب الرابط معطل") 
return false  
end
local link = database:get(bot_id.."Hydra:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:del(bot_id.."Hydra:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
database:set(bot_id.."Hydra:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."Hydra:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."Hydra:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if database:get(bot_id.."Hydra:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."Hydra:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."Hydra:Chek:Welcome"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"☑┇تم تفعيل ترحيب المجموعه") 
return false  
end
if text == "تعطيل الترحيب" and Addictive(msg) then  
database:del(bot_id.."Hydra:Chek:Welcome"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"☑┇تم تعطيل ترحيب المجموعه") 
return false  
end
if text == "مسح الترحيب" or text == "حذف الترحيب" then 
if Addictive(msg) then
database:del(bot_id.."Hydra:Get:Welcome:Group"..msg.chat_id_) 
...
local list = database:smembers(bot_id.."Hydra:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Hydra:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Hydra:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Hydra:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local Hydra_Msg = database:get(bot_id.."Hydra:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Hydra_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."Hydra:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Hydra:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"📫┇ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Hydra:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Hydra:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Hydra:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."Hydra:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Hydra:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Hydra:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Hydra:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."Hydra:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Hydra:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Hydra:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:get(bot_id.."Hydra:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
...
if Addictive(msg) then
database:setex(bot_id.."Hydra:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."Hydra:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" then 
local Set_Rules = database:get(bot_id.."Hydra:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."Hydra:List:Cmd:Group:New"..msg.chat_id_.."")
t = "🔰┇قائمه الاوامر المضافه  \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."Hydra:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."Hydra:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Hydra:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."Hydra:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"🔰┇تم مسح جميع الاوامر التي تم اضافتها")  
end
end
if text == "اضف امر" and Constructor(msg) then
database:set(bot_id.."Hydra:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"🔰┇الان ارسل لي الامر القديم ..")  
return false
end
if text == "حذف امر" or text == "مسح امر" then 
if Constructor(msg) then
database:set(bot_id.."Hydra:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local list = database:smembers(bot_id.."Hydra:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."Hydra:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
local list = database:smembers(bot_id.."Hydra:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Hydra:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."Hydra:Coomds"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"🔘┇تم مسح الصلاحيات")
end
if text and text:match("^اضف صلاحيه (.*)$") and Addictive(msg) then 
ComdNew = text:match("^اضف صلاحيه (.*)$")
database:set(bot_id.."Hydra:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."Hydra:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."Hydra:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
local textn = database:get(bot_id.."Hydra:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."Hydra:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:del(bot_id.."Hydra:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."Hydra:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."Hydra:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."Hydra:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."Hydra:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."Hydra:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."Hydra:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."Hydra:Add:Rd:Manager:moving"..v..msg.chat_id_) then
db = "متحركه 🎭"
elseif database:get(bot_id.."Hydra:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمه 📢"
elseif database:get(bot_id.."Hydra:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ملصق 🃏"
elseif database:get(bot_id.."Hydra:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رساله ✉"
elseif database:get(bot_id.."Hydra:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صوره 🎇"
elseif database:get(bot_id.."Hydra:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيديو 📹"
elseif database:get(bot_id.."Hydra:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف 📁"
elseif database:get(bot_id.."Hydra:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنيه 🎵"
end
text = text..""..k..">> ("..v..") » {"..db.."}\n"
end
...
database:set(bot_id.."Hydra:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."Hydra:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."Hydra:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Hydra:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."Hydra:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."Hydra:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."Hydra:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."Hydra:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"📫┇ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."Hydra:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
...
database:del(bot_id.."Hydra:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Hydra:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Hydra:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Hydra:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."Hydra:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."Hydra:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."Hydra:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."Hydra:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."Hydra:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Hydra:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
database:srem(bot_id.."Hydra:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."Hydra:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'Hydra:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Hydra:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."Hydra:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."Hydra:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."Hydra:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."Hydra:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."Hydra:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."Hydra:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."Hydra:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
...
local list = database:smembers(bot_id.."Hydra:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."Hydra:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."Hydra:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."Hydra:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."Hydra:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."Hydra:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."Hydra:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."Hydra:Add:Rd:Sudo:File"..v)
database:del(bot_id.."Hydra:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."Hydra:List:Rd:Sudo")
end
...
text = "\n⛔┇قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if database:get(bot_id.."Hydra:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif database:get(bot_id.."Hydra:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif database:get(bot_id.."Hydra:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif database:get(bot_id.."Hydra:Add:Rd:Sudo:Text"..v) then
db = "رساله 📹"
elseif database:get(bot_id.."Hydra:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif database:get(bot_id.."Hydra:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif database:get(bot_id.."Hydra:Add:Rd:Sudo:File"..v) then
db = "ملف 📁"
elseif database:get(bot_id.."Hydra:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
end
text = text..""..k.." >> ("..v..") » {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."Hydra:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."Hydra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."Hydra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."Hydra:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."Hydra:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."Hydra:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."Hydra:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."Hydra:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."Hydra:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."Hydra:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."Hydra:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"📌┇تم حفظ الرد بنجاح")
return false  
end  
...
send(msg.chat_id_, msg.id_,"📥┇ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Hydra:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevHydra(msg) then 
send(msg.chat_id_, msg.id_,"📫┇ ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."Hydra:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
...
database:sadd(bot_id.."Hydra:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
...
for k,v in pairs(list) do
database:del(bot_id..'Hydra:'..v..text)
end
database:del(bot_id.."Hydra:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."Hydra:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."Hydra:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'Hydra:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."Hydra:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."Hydra:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."Hydra:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."Hydra:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."Hydra:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."Hydra:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."Hydra:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."Hydra:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."Hydra:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."Hydra:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."Hydra:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."Hydra:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."Hydra:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Special:User"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."Hydra:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Constructor"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
elseif database:sismember(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Manager"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Constructor"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."Hydra:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Special:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Manager"..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id.."Hydra:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id.."Hydra:Special:User"..msg.chat_id_, result.sender_user_id_)
end
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."Hydra:User:Name"..v.user_id_) then
t = t..""..x.." - {[@"..database:get(bot_id.."Hydra:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
if not database:get(bot_id.."Hydra:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."Hydra:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل اطردني" and Owner(msg) then  
database:set(bot_id.."Hydra:Kick:Me"..msg.chat_id_,true)  
Text = "\n📫┇تم تعطيل امر اطردني"
send(msg.chat_id_, msg.id_,Text) 
end
...
if database:sismember(bot_id.."Hydra:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Hydra:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_Hydra(extra, result, success)
if database:sismember(bot_id.."Hydra:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."Hydra:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."Hydra:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."Hydra:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."Hydra:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
local UserName = (b.username_ or "HYDRATEAM")
...
database:sadd(bot_id.."Hydra:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."Hydra:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"📫┇ تم مغادرة المجموعه") 
database:srem(bot_id.."Hydra:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."Hydra:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادره" and DevHydra(msg) then   
database:del(bot_id.."Hydra:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"📫┇تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevHydra(msg) then  
database:set(bot_id.."Hydra:Left:Bot"..msg.chat_id_,true)   
...
if DevHydra(msg) then
database:setex(bot_id.."Hydra:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
database:setex(bot_id.."Hydra:Hydra:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."Hydra:Hydra:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"🔘┇ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n📫┇للخروج ارسل الغاء ") 
return false
end  
...
database:del(bot_id.."Hydra:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n📫┇تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevHydra(msg) then  
database:set(bot_id.."Hydra:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n📫┇تم تعطيل الاذاعه") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."Hydra:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."Hydra:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."Hydra:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."Hydra:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقيد"     
elseif database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."Hydra:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."Hydra:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقيد"    
elseif database:get(bot_id.."Hydra:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."Hydra:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."Hydra:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."Hydra:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقيد"    
elseif database:get(bot_id.."Hydra:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."Hydra:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقيد"    
elseif database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."Hydra:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."Hydra:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقيد"    
elseif database:get(bot_id.."Hydra:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."Hydra:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."Hydra:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."Hydra:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif database:get(bot_id.."Hydra:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."Hydra:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."Hydra:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقيد"    
elseif database:get(bot_id.."Hydra:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."Hydra:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."Hydra:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."Hydra:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."Hydra:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
...
if not database:get(bot_id.."Hydra:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."Hydra:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."Hydra:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n🔰┇ااعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ "..
"\n🔏┇علامة ال {✓} تعني مفعل"..
...
if Owner(msg) then
database:del(bot_id.."Hydra:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '📌┇تم ازالة كليشة الايدي ')
end
return false  
end 

if database:get(bot_id.."Hydra:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"📫┇تم الغاء تعين الايدي") 
database:del(bot_id.."Hydra:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."Hydra:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."Hydra:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
...
if text and text:match('^تنظيف (%d+)$') and DevHydraa(msg) then    
...
local Id = data.id_
local NumMsg = database:get(bot_id..'Hydra:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'Hydra:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."Hydra:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."Hydra:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if database:get(bot_id.."Hydra:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."Hydra:Set:Sma"..msg.chat_id_)
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","🍵","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","🎭","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗","📂","📅","📪","📫","📬","📭","⏰","📺","🎚","☎️","📡"}
SM = Random[math.random(#Random)]
database:set(bot_id.."Hydra:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,"🔰┇اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
end
if text == ""..(database:get(bot_id.."Hydra:Random:Sm"..msg.chat_id_) or "").."" and not database:get(bot_id.."Hydra:Set:Sma"..msg.chat_id_) then
if not database:get(bot_id.."Hydra:Set:Sma"..msg.chat_id_) then 
...
database:set(bot_id.."Hydra:Set:Sma"..msg.chat_id_,true)
return false
end 
if text == "الاسرع" or tect == "ترتيب" then
if database:get(bot_id.."Hydra:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."Hydra:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
database:set(bot_id.."Hydra:Klam:Speed"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."Hydra:Klam:Speed"..msg.chat_id_) or "").."" and not database:get(bot_id.."Hydra:Speed:Tr"..msg.chat_id_) then
if not database:get(bot_id.."Hydra:Speed:Tr"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ الاسرع , ترتيب }")
database:incrby(bot_id.."Hydra:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."Hydra:Speed:Tr"..msg.chat_id_,true)
end 

if text == "حزوره" then
if database:get(bot_id.."Hydra:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."Hydra:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
database:set(bot_id.."Hydra:Klam:Hzor"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."Hydra:Klam:Hzor"..msg.chat_id_) or "").."" and not database:get(bot_id.."Hydra:Set:Hzora"..msg.chat_id_) then
if not database:get(bot_id.."Hydra:Set:Hzora"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ حزوره }")
database:incrby(bot_id.."Hydra:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."Hydra:Set:Hzora"..msg.chat_id_,true)
end 

if text == "معاني" then
if database:get(bot_id.."Hydra:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."Hydra:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
database:set(bot_id.."Hydra:Maany"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."Hydra:Maany"..msg.chat_id_) or "").."" and not database:get(bot_id.."Hydra:Set:Maany"..msg.chat_id_) then
if not database:get(bot_id.."Hydra:Set:Maany"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ معاني }")
database:incrby(bot_id.."Hydra:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."Hydra:Set:Maany"..msg.chat_id_,true)
end 
if text == "العكس" then
if database:get(bot_id.."Hydr:Lock:Games"..msg.chat_id_) then
database:del(bot_id.."Hydr:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
database:set(bot_id.."Hydr:Set:Aks:Game"..msg.chat_id_,name)
...
database:set(bot_id.."Hydr:Set:Aks"..msg.chat_id_,true)
end 

if database:get(bot_id.."Hydr:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"📬┇عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
local GETNUM = database:get(bot_id.."Hydr:GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."Hydr:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."Hydr:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
database:incrby(bot_id.."Hydr:Add:Num"..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,"🔖┇مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸┇تم اضافة { 5 } من النقاط \n")
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:incrby(bot_id.."Hydr:SADD:NUM"..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(database:get(bot_id.."Hydr:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)) >= 3 then
database:del(bot_id.."Hydr:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."Hydr:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
database:set(bot_id.."Hydr:GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,"\n📛┇اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".."💢┇ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."🔖┇سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
database:setex(bot_id.."Hydr:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end

if database:get(bot_id.."Hydr:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"📬┇عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Hydr:Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."Hydr:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if database:get(bot_id.."Hydr:Lock:Games"..msg.chat_id_) then   
Num = math.random(1,6)
database:set(bot_id.."Hydr:Games:Bat"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
database:setex(bot_id.."Hydr:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
...
database:del(bot_id.."Hydr:Set:Moktlf:Bot"..msg.chat_id_)
database:set(bot_id.."Hydr::Set:Moktlf"..msg.chat_id_,name)
...
if text == ""..(database:get(bot_id.."Hydr::Set:Moktlf"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."Hydr:Set:Moktlf:Bot"..msg.chat_id_) then 
database:del(bot_id.."Hydr::Set:Moktlf"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ المختلف }")
database:incrby(bot_id.."Hydr:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."Hydr:Set:Moktlf:Bot"..msg.chat_id_,true)
end
if text == "امثله" then
if database:get(bot_id.."Hydr:Lock:Games"..msg.chat_id_) then
mthal = {"جوز","ضراطه","الحبل","الحافي","شقره","بيدك","سلايه","النخله","الخيل","حداد","المبلل","يركص","قرد","العنب","العمه","الخبز","بالحصاد","شهر","شكه","يكحله",};
name = mthal[math.random(#mthal)]
database:set(bot_id.."Hydr:Set:Amth"..msg.chat_id_,name)
database:del(bot_id.."Hydr:Set:Amth:Bot"..msg.chat_id_)
...
if text == ""..(database:get(bot_id.."Hydr:Set:Amth"..msg.chat_id_) or "").."" then 
if not database:get(bot_id.."Hydr:Set:Amth:Bot"..msg.chat_id_) then 
database:del(bot_id.."Hydr:Set:Amth"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"🎁┇الف مبروك لقد فزت \n♻┇للعب مره اخره ارسل ~{ امثله }")
database:incrby(bot_id.."Hydr:Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id.."Hydr:Set:Amth:Bot"..msg.chat_id_,true)
end
if text == "تعطيل الالعاب" and Owner(msg) then   
database:del(bot_id.."Hydr:Lock:Games"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"\n☑┇تم تعطيل الالعاب") 
end
if text == "تفعيل الالعاب" and Owner(msg) then  
database:set(bot_id.."Hydr:Lock:Games"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"\n☑┇تم تفعيل الالعاب") 
end
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'Hydra:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '📨┇عدد رسائلك هنا *~ '..nummsg..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'Hydra:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '☑┇تم مسح جميع رسائلك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'Hydra:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '✏┇عدد التعديلات هنا *~ '..edit..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'Hydra:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '☑┇تم مسح جميع تعديلاتك '
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."Hydra:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '👥┇عدد جهاتك المضافه هنا *~ '..addmem..'*'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'Hydra:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '☑┇تم مسح جميع جهاتك المضافه '
send(msg.chat_id_, msg.id_,Text) 
end

if text == "مجوهراتي" then 
local Num = database:get(bot_id.."Hydr:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
if Num == 0 then 
...
if tonumber(database:get(bot_id.."Hydr:Add:Num"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,"🔖┇ليس لديك جواهر من الالعاب \n📬┇اذا كنت تريد ربح الجواهر \n📌┇ارسل الالعاب وابدأ اللعب ! ") 
else
local NUM_GAMES = database:get(bot_id.."Hydr:Add:Num"..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,"\n💢┇ليس لديك جواهر بهاذا العدد \n📬┇لزيادة مجوهراتك في اللعبه \n📌┇ارسل الالعاب وابدأ اللعب !") 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id.."Hydr:Add:Num"..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id.."Hydra:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
if database:get(bot_id.."Hydr:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."Hydr:id:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "📮┇تم الغاء الامر ") 
database:del(bot_id.."Hydr:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Hydr:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."Hydra:id:user"..msg.chat_id_)  
database:del(bot_id.."Hydr:Msg_User"..msg.chat_id_..":"..msg.sender_user_id_) 
database:incrby(bot_id.."Hydra:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"☑┇تم اضافة له {"..numadded.."} من الرسائل")  
end
if database:get(bot_id.."Hydr:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
database:del(bot_id.."Hydr:idgem:user"..msg.chat_id_)  
send(msg.chat_id_, msg.id_, "☑┇تم الغاء الامر ") 
database:del(bot_id.."Hydr:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Hydr:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = database:get(bot_id.."Tshak:idgem:user"..msg.chat_id_)  
database:incrby(bot_id.."Hydr:Add:Num"..msg.chat_id_..iduserr,numadded)  
send(msg.chat_id_, msg.id_,"☑┇تم اضافة له {"..numadded.."} من المجوهرات")  
end
------------------------------------------------------------
if text and text:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then    
taha = text:match("^اضف رسائل (%d+)$")
database:set(bot_id.."Hydr:id:user"..msg.chat_id_,taha)  
database:setex(bot_id.."Hydr:numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:set(bot_id.."Hydr:idgem:user"..msg.chat_id_,taha)  
database:setex(bot_id.."Hydr:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
database:incrby(bot_id.."Hydr:Add:Num"..msg.chat_id_..result.sender_user_id_,Num)  
...
function reply(extra, result, success)
database:del(bot_id.."Hydr:Msg_User"..msg.chat_id_..":"..result.sender_user_id_) 
database:incrby(bot_id.."Hydra:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
local pv = database:smembers(bot_id..'Hydra:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'Hydra:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = database:smembers(bot_id..'Hydra:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:del(bot_id..'Hydra:Free:Add:Bots') 
...
database:set(bot_id..'Hydra:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'👥┇ تم وضع عدد الاعضاء *~'..Num..'* عضو')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'Hydra:Chek:Groups')  
local Users = database:scard(bot_id..'Hydra:UsersBot')  
send(msg.chat_id_, msg.id_,'🔘┇احصائيات البوت \n\n👥┇عدد المجموعات *~ '..Groups..'\n👤┇عدد المشتركين ~ '..Users..'*')
end
if text == 'جلب نسخه احتياطيه' and DevHydra(msg) then
local list = database:smembers(bot_id..'Hydra:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'Hydra Chat'
ASAS = database:smembers(bot_id.."Hydra:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."Hydra:Constructor"..v)
MDER = database:smembers(bot_id.."Hydra:Manager"..v)
MOD = database:smembers(bot_id.."Hydra:Mod:User"..v)
link = database:get(bot_id.."Hydra:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"Hydra":"'..NAME..'",'
else
t = t..',"'..v..'":{"Hydra":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'Hydra:Text_Dev')
if Text_Dev then 
...
local Check_File_is_Found = io.open("Hydra_Files/"..name,"r")
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevHydra(msg) then
...
if text == "مسح جميع الملفات" and DevHydra(msg) then
os.execute("rm -fr Hydra_Files/*")
...
database:sadd(bot_id.."Hydra:Constructor"..Groups[i], v)
end
local list3 = database:smembers('hydra:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."Hydra:Manager"..Groups[i], v)
end
local list4 = database:smembers('hydra:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."Hydra:Mod:User"..Groups[i], v)
end
...
for i = 1, #Users do
database:sadd(bot_id..'Hydra:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'👥┇تم نقل : '..#Groups..' كروب\n👤┇تم نقل : '..#Users..' مشترك \n🔘┇من التحديث القديم الى التحديث الجديد')
end
if text == 'حذف كليشه المطور' and DevHydra(msg) then
database:del(bot_id..'Hydra:Text_Dev')
send(msg.chat_id_, msg.id_,'☑┇ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevHydra(msg) then
database:set(bot_id..'Hydra:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'📫┇ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'Hydra:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'Hydra:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'🔖┇تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'Hydra:Text_Dev',text)
database:del(bot_id..'Hydra:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'🔰┇تم حفظ كليشة المطور')
return false
end
if text == 'رفع النسخه الاحتياطيه' and DevHydra(msg) then   
...
database:sadd(bot_id..'Hydra:Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'Hydra:Chek:Groups',msg.chat_id_) then
...
database:set(bot_id.."Hydra:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
Reply_Status(msg,result.id_,'reply_Add','☑┇تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'Hydra:Chek:Groups',msg.chat_id_)  
database:sadd(bot_id..'Hydra:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'Hydra:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'Hydra:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not DevHydra(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
database:srem(bot_id..'Hydra:Chek:Groups','-100'..data.channel_.id_)  
end
end
...
if text and not database:sismember(bot_id..'Hydra:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'Hydra:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'Hydra:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."Hydra:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."Hydra:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."Hydra:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."Hydra:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."Hydra:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."Hydra:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."Hydra:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."Hydra:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."Hydra:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
...
database:incr(bot_id..'Hydra:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."Hydra:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."Hydra:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."Hydra:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."Hydra:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'Hydra:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'Hydra:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'Hydra:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'Hydra:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'Hydra:Chek:Groups',v)  
end
...
database:sadd(bot_id..'Hydra:Chek:Groups',v)  
end end,nil)
